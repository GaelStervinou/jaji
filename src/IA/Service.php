...
final class Service
{
    ...
    public function generateDiagnostics(int $patientId): void
    {
        ...
        try {
            $patientInformation = PatientInformation::retrievePatientInformation($patientId, $this->entityManager)->toJson();
        } catch (\Throwable $e) {
